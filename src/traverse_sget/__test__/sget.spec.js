...
describe('transform safe get', function () {
    it('should pass when path is string literal', () => {
        ...
        expect(transformedFile).toBe(`foo === undefined ? void 0 : foo.bar === undefined ? void 0 : foo.bar['a'] === undefined ? void 0 : foo.bar['a']['b'] === undefined ? void 0 : foo.bar['a']['b']['c'] === undefined ? void 0 : foo.bar['a']['b']['c'];`)
    })
})